...
export default function ProgramRecommendations() {
  ...
  const { userMetrics, getRecommendedProgramsForUser, selectProgram } = usePrograms();
  ...
  useEffect(() => {
    ...
    if (userMetrics) {
      ...
      // Handle case where user metrics aren't available
  ...
  const handleContinue = async () => {
    ...
    try {
      ...
      // Navigate to dashboard after selecting a program
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <View style={styles.header}>
        ...
        <Text variant="bodyLarge" style={styles.subtitle}>
          Based on your goals and metrics
        </Text>
      </View>
